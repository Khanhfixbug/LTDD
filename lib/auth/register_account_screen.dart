...
class _RegisterAccountScreenState extends State<RegisterAccountScreen> {
  ...
  Future<void> _handleCreateAccount() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Tạo tài khoản thành công. Vui lòng xác minh email.'),
        ),
      );
      ...
      if (e.code == 'email-already-in-use') {
        final email = _emailController.text.trim();
        final hasUserDocument =
            await _loginRepository.userDocumentExistsByEmail(email);

        if (!hasUserDocument) {
          await _loginRepository.removeGroupMembershipsByMissingEmail(email);
        }
  ...
  Widget _requiredInputLabel(String text) {
    return RichText(
      text: TextSpan(
        text: text,
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          label: _requiredInputLabel('Email'),
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          label: _requiredInputLabel('Mật khẩu'),
